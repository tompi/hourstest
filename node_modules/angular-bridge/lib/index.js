...
AngularBridge.prototype.collectionGet = function() {
    return _.bind(function(req, res, next) {
        ...
        if (req.resource.options !== null && typeof req.resource.options.query !== 'undefined') {
...
AngularBridge.prototype.generateHiddenFields = function(resource) {
    ...
    if (resource.options === null || typeof resource.options.hide == 'undefined') return {};
...
AngularBridge.prototype.epureRequest = function(req, resource) {
    ...
    if (resource.options === null || (typeof resource.options.hide == 'undefined' && typeof resource.options.readOnly == 'undefined' && typeof resource.options.force == 'undefined')) return req_data;
...
AngularBridge.prototype.entity = function() {
    return _.bind(function(req, res, next) {
        ...
        //
        var query = req.resource.model.findOne({
            _id: req.params.id
